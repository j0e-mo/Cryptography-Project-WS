...
const Port_ConfigType Port_PinConfig = {
        PORT_PortA , PORT_Pin0, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW , ALT1 , STD_ON, STD_ON,
        PORT_PortA , PORT_Pin1, PORT_PIN_OUT, PULL_UP, PORT_PIN_LEVEL_LOW , ALT1 , STD_ON, STD_ON,
...
//        PORT_PortB , PORT_Pin0, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW , ALT1 , STD_ON, STD_ON,
//        PORT_PortB , PORT_Pin1, PORT_PIN_OUT, PULL_UP, PORT_PIN_LEVEL_LOW , ALT1 , STD_ON, STD_ON,
//        PORT_PortB , PORT_Pin2, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW , ALT3 , STD_ON, STD_ON,
//        PORT_PortB , PORT_Pin3, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW , ALT3 , STD_ON, STD_ON,
...
//        PORT_PortD , PORT_Pin2, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW , GPIO_MODE , STD_ON, STD_ON,
...
//        PORT_PortF , PORT_Pin4, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW, GPIO_MODE , STD_ON, STD_ON
