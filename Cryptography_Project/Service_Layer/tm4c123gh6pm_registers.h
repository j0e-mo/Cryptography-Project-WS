...
#define GPIO_PORTB_ODR_REG        (*((volatile uint32 *)0x4000550C)) // GPIO Open Drain Select
...
#define UART1_DR                (*((volatile uint32 *)(UART1_BASE + UART_DR_OFFSET)))
#define UART1_FR                (*((volatile uint32 *)(UART1_BASE + UART_FR_OFFSET)))
#define UART1_IBRD              (*((volatile uint32 *)(UART1_BASE + UART_IBRD_OFFSET)))
#define UART1_FBRD              (*((volatile uint32 *)(UART1_BASE + UART_FBRD_OFFSET)))
#define UART1_LCRH              (*((volatile uint32 *)(UART1_BASE + UART_LCRH_OFFSET)))
#define UART1_CTL               (*((volatile uint32 *)(UART1_BASE + UART_CTL_OFFSET)))

// UART Flag Register Bits
#define UART_FR_RXFE            0x00000010  // Receive FIFO Empty (bit 4)
#define UART_FR_TXFF            0x00000020  // Transmit FIFO Full (bit 5)
#define UART_FR_RXFF            0x00000040  // Receive FIFO Full (bit 6)
#define UART_FR_TXFE            0x00000080  // Transmit FIFO Empty (bit 7)
