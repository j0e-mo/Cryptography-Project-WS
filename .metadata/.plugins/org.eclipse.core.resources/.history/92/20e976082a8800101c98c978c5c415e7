...
/*
 * Minimal mbedTLS configuration for SHA-256 only on TM4C123GH6PM
 * This config explicitly disables features we don't need to avoid dependency issues
 */
...
/* Enable ONLY what we need for SHA-256 */
#define MBEDTLS_SHA256_C
#define MBEDTLS_SHA256_SMALLER  /* Use smaller implementation for embedded */

/* Explicitly disable everything else to avoid dependency conflicts */
...
/* Skip the check_config.h include initially to avoid conflicts */
